    ...
    <div className="p-6 rounded-3xl bg-gradient-to-br from-[#183A2A]/5 via-[#EEF5EC]/50 to-white border border-[#35624B]/20 shadow-md">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-serif-display font-bold text-[#183A2A]">Site Findings</h3>
        ...
        {canEdit && !adding && (
          <button
            ...
            className="self-start sm:self-auto flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border border-[#183A2A]/20 bg-white text-[#183A2A] text-xs font-medium hover:border-[#183A2A]/50 transition-colors"
          >
      ...
      {query.isSuccess && query.data.length === 0 && !adding && (
        <EmptyState
          icon={Lightbulb}
          title="No findings recorded yet"
          hint="Nothing is generated automatically, so this panel stays empty until someone writes a real observation."
        />
      )}
      ...
      <div className="mt-4 pt-3 border-t border-black/5 flex items-start gap-1.5 text-[11px] text-[#6F6F6F]">
        ...
        <span>
          ...
          against them. Analyst findings are interpretation. Nothing here is generated at
          render time.
        </span>
      </div>
    </div>
